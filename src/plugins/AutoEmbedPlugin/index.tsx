...
import { INSERT_SPOTIFY_COMMAND } from '../SpotifyPlugin';
...
export const SpotifyEmbedConfig: EditorEmbedConfig = {
    contentName: 'Spotify Track',

    exampleUrl:
        'https://open.spotify.com/track/4iV5W9uYEdYUVa79Axb7Rh?si=12W7NnNhZO7m343P',

    icon: <i className="icon spotify" />,

    insertNode: (editor: LexicalEditor, result: EmbedMatchResult) => {
        editor.dispatchCommand(INSERT_SPOTIFY_COMMAND, result.id);
    },

    keywords: ['spotify', 'music', 'track'],
...
export const YoutubeEmbedConfig: EditorEmbedConfig = {
    ...
    exampleUrl: 'https://youtu.be/ACNgFW50EbU?si=12W7NnNhZO7m343P',
